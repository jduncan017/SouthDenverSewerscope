...
/*
 * Fixed bottom action bar, phones only. Most of this site's traffic arrives
...
export function MobileCtaBar() {
  return (
    <div className="MobileCtaBar border-p3 bg-p4 fixed inset-x-0 bottom-0 z-40 grid grid-cols-2 gap-3 border-t px-4 py-3 lg:hidden">
      <a
