    ...
    <SectionWrapper tone="white" maxWidth="section">
      <div className="PrivacyBody max-w-text flex flex-col gap-8">
        <SectionHeader
          eyebrow="Legal"
          title="Privacy Policy"
          description={`Short version: we use what you send us to get back to you about your sewer line, and nothing else. We don't sell your information, and we don't add you to a mailing list.`}
        />
        ...
        <section className="PrivacySection flex flex-col gap-4">
          ...
          <p className="text-g3">
            ...
            it. If you call or text us, we have your phone number. That&apos;s all
          ...
          <p className="text-g3">
            ...
            requested. This is ordinary server logging and we don&apos;t use it to
            identify anyone.
          </p>
        </section>
        ...
        <section className="PrivacySection flex flex-col gap-4">
          ...
          <ul className="flex flex-col gap-3">
            ...
            <BulletItem>
              To keep basic records of work we&apos;ve done, which we&apos;re required
        ...
        <section className="PrivacySection flex flex-col gap-4">
          ...
          <p className="text-g3">
            ...
            so they can do that work. We don&apos;t sell your information, and we
            don&apos;t share it with anyone who wants to market to you.
          </p>
        </section>
        ...
        <section className="PrivacySection flex flex-col gap-4">
          ...
          <p className="text-g3">
            Inquiries that don&apos;t turn into work are kept for about a year, in
            ...
            information at any time, and we will unless we&apos;re legally required
            to hold it.
          </p>
        </section>
